...
const Layout = ({ children }) => {
  ...
  // DYNAMIC VARIABLE: 5rem (80px) if collapsed, 16rem (256px) if expanded
  ...
  return (
    <div 
        className="min-h-screen bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100 transition-colors duration-200 flex flex-col md:flex-row"
        style={{ '--sidebar-width': sidebarWidth }} // <--- INJECT VARIABLE HERE
    >
